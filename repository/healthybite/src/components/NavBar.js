    ...
    return (
        ...
        <div className=" top-0 z-30 sticky overflow-y-hidden sm:overflow-y-auto sm:absolute w-full flex flex-col items-center justify-center">
            <div className="bg-healthyGreen w-full shadow-xl py-3 flex justify-center">
                 <div className="flex flex-row w-11/12 xl:w-full justify-between items-center bg-healthyGreen flex-nowrap">
                    <h1 className="font-belleza text-2xl w-3/4 lg:text-4xl text-white md:w-auto ml-4 mr-4 shrink-0">Healthy Bite</h1>
                    ...
                    <div className="hidden md:flex justify-between items-center flex-grow"> 
                        ...
                        <div className="flex justify-end items-center mr-4 ml-4 shrink-0">
            ...
            { openBar &&
                <div className="w-full xs:w-11/12 xs:mt-2 z-10 right-0 bg-healthyGreen xs:bg-none xs:rounded-3xl flex items-center justify-center overflow-y-hidden md:hidden"> 
